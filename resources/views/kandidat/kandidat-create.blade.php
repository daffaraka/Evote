    ...
    <div class="container py-4">
        <form action="{{ route('kandidat.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_pasangan" class="form-control" required id="nama_pasangan">
            </div>
            <div class="mb-3">
                <label for="">Nama Ketua</label>
                <input type="text" name="nama_ketua" class="form-control" required id="nama_ketua">
            </div>
            <div class="mb-3">
                <label for="">Nama Wakil</label>
                <input type="text" name="nama_wakil" class="form-control" required id="nama_wakil">
            </div>
            <div class="mb-3">
                <label for="">Visi</label>
                <input type="text" name="visi" class="form-control" required id="visi">
            </div>
            <div class="mb-3">
                <label for="">Misi</label>
                <input type="text" name="misi" class="form-control" id="misi" required>
            </div>
            <div class="mb-3">
                <label for="">Program Kerja</label>
                <input type="text" name="program_kerja" class="form-control" required id="program_kerja">
            </div>
